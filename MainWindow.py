...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.steamLabel.setGeometry(QtCore.QRect(460, 219, 391, 81))
        ...
        self.steamPath.setGeometry(QtCore.QRect(455, 300, 400, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.steamLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Steam Path<br/></span><br/>Path to where your steam folder is located. This is for the play function of the mod manager.</p><p>(If you rather open the game via steam itself you can leave this empty)</p></body></html>"))
