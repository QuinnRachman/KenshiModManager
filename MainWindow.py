...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.workshopPath.setGeometry(QtCore.QRect(455, 200, 400, 20))
        ...
        self.workshopLabel.setGeometry(QtCore.QRect(460, 99, 391, 100))
        ...
        self.steamLabel = QtWidgets.QLabel(self.centralwidget)
        self.steamLabel.setGeometry(QtCore.QRect(460, 219, 391, 97))
        self.steamLabel.setContextMenuPolicy(QtCore.Qt.PreventContextMenu)
        self.steamLabel.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.steamLabel.setTextFormat(QtCore.Qt.AutoText)
        self.steamLabel.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.steamLabel.setWordWrap(False)
        self.steamLabel.setObjectName("steamLabel")
        self.steamPath = QtWidgets.QLineEdit(self.centralwidget)
        self.steamPath.setGeometry(QtCore.QRect(455, 320, 400, 20))
        self.steamPath.setObjectName("steamPath")
        self.selectRootPath = QtWidgets.QPushButton(self.centralwidget)
        self.selectRootPath.setGeometry(QtCore.QRect(860, 69, 31, 20))
        self.selectRootPath.setObjectName("selectRootPath")
        self.selectWorkshopPath = QtWidgets.QPushButton(self.centralwidget)
        self.selectWorkshopPath.setGeometry(QtCore.QRect(860, 200, 31, 20))
        self.selectWorkshopPath.setObjectName("selectWorkshopPath")
        self.selectSteamPath = QtWidgets.QPushButton(self.centralwidget)
        self.selectSteamPath.setGeometry(QtCore.QRect(860, 320, 31, 20))
        self.selectSteamPath.setObjectName("selectSteamPath")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.configButton.setText(_translate("MainWindow", "Save load order"))
        ...
        self.workshopLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Workshop Path<br/></span><br/>Put the folder where your kenshi workshop mods are located, usually it\'s in:</p><p>If you don\'t use steam for kenshi you can leave this empty.</p><p>&lt;WhereSteamIs&gt;/steamapps/workshop/content/233860</p></body></html>"))
        self.pathButton.setText(_translate("MainWindow", "Save paths"))
        self.steamLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Steam Path<br/></span><br/>Path to where your steam folder is located. </p><p>This is for the play function of the mod manager.</p><p>(If you rather open the game via steam itself you can leave this empty)</p></body></html>"))
        self.selectRootPath.setText(_translate("MainWindow", "..."))
        self.selectWorkshopPath.setText(_translate("MainWindow", "..."))
        self.selectSteamPath.setText(_translate("MainWindow", "..."))
